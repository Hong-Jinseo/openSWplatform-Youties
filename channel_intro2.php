	...
	<body>
		...
		<header id="main_header_logo">
			...
			<div id="header-login">
				<?php
				session_start(); // 세션
                $connect = mysqli_connect('localhost', 'root', '111111', 'youties') or die ("connect fail");
				...
				<form action="save_review.php" method="POST">
						...
						<div id="div4-grid">
							...
							<div id="div4-4" class="inner-div-4">
								...
								<div id="write-review">
									<textarea id="review-title" name="title" rows="1" placeholder="Write a headline for your review here" required></textarea><br>
									<textarea id="review-content" name="content" rows="7" class="textarea_test" placeholder="Write your review here" requried></textarea> <!--onkeyup="this.style.height='26p'; this.style.height = this.scrollHeight+'px'"></textarea-->
