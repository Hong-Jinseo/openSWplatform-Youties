...
$result_4 = mysqli_query($conn, "SELECT * FROM reviews WHERE parent='$get_you' ORDER BY rating ASC, id DESC") or die(mysqli_error($conn));
$result_tag = mysqli_query($conn, "SELECT * FROM tags WHERE parent='$get_you' ORDER BY rating ASC, id DESC") or die(mysqli_error($conn));
$cnt = 0;
            ...
            <div class="main-container">
                ...
                <div id="option" class="inner-div">
                    ...
                    <form id="o3" action="review_neg.php" method="POST">
                        <button type="submit" id="opt4" name="opt4" class="opt-btn"  value="0" style="color: #ffffff; background: #c0412b">Negative</button>
                        <input type="hidden" name="channel_key" value="<?php echo $get_you?>">
                    </form>
